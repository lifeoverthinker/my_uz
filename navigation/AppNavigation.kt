...
import com.example.my_uz_android.ui.components.Fab // Import nowego, zmodyfikowanego FABa

// --- IMPORTY COROUTINES ---
import kotlinx.coroutines.launch

// --- IMPORTY EKRANÓW I VIEWMODELI ---
    ...
    ModalNavigationDrawer(
        ...
        Scaffold(
            ...
            floatingActionButton = {
                // FAB widoczny TYLKO na ekranie głównym
            ...
            NavHost(
                ...
                // ==========================================
                // POZOSTAŁA CZĘŚĆ EKRANÓW - BEZ ZMIAN!
                // ==========================================
                composable("landing") {
                ...
                composable(Screen.Index.route) {
                    IndexScreen(
                        onSubjectClick = { subjectName ->
                            navController.navigate("subject_grades/$subjectName")
                        },
                        onAddGradeClick = { navController.navigate("add_grade") },
                        onAddAbsenceClick = { navController.navigate("add_absence") },
